// BCGtest.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CBCGtestApp, CBCGPWinApp)
...
// CBCGtestApp construction

CBCGtestApp::CBCGtestApp()
{
...
// The one and only CBCGtestApp object

CBCGtestApp theApp;


// CBCGtestApp initialization
...
BOOL CBCGtestApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CBCGtestDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CBCGtestView));
	if (!pDocTemplate)
		return FALSE;
